...
def main(clip_model_type: str,dataset, train_or_val = "train"):
    ...
    out_path = f"./data/"+dataset+"/oscar_split_val.pkl"
    ...
    with open('./data/'+dataset+'/annotations/valid-de_gmt.jsonl', 'r') as f:        
        for line in tqdm(f):
            i=i+1
            d=json.loads(line)
            #d =isinstance(j_line, dict)
            ...
            #else :
            filename = "./data/"+dataset+"/"+train_or_val+"/"+img_path
